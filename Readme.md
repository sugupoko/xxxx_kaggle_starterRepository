...
以下のスキルはリポジトリに含まれていないため、手動でインストールしてください。

## pptx（プレゼン資料作成）

Anthropic公式のスライド作成スキル。コンペの発表資料やチーム共有資料の作成に。

```bash
# .claude/skills/pptx/ にスキルを配置
mkdir -p .claude/skills/pptx/scripts/office
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/SKILL.md -o .claude/skills/pptx/SKILL.md
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/editing.md -o .claude/skills/pptx/editing.md
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/pptxgenjs.md -o .claude/skills/pptx/pptxgenjs.md
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/scripts/thumbnail.py -o .claude/skills/pptx/scripts/thumbnail.py
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/scripts/add_slide.py -o .claude/skills/pptx/scripts/add_slide.py
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/scripts/clean.py -o .claude/skills/pptx/scripts/clean.py
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/scripts/office/unpack.py -o .claude/skills/pptx/scripts/office/unpack.py
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/scripts/office/pack.py -o .claude/skills/pptx/scripts/office/pack.py
curl -sL https://raw.githubusercontent.com/anthropics/skills/main/skills/pptx/scripts/office/soffice.py -o .claude/skills/pptx/scripts/office/soffice.py
...
ソース: https://github.com/anthropics/skills/tree/main/skills/pptx
